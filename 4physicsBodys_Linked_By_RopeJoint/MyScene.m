...
@property SKPhysicsJoint* myPinJoint3;
@property SKPhysicsJoint* myPinJoint4;
@property SKPhysicsJoint* mySpringJoint5;
@property SKPhysicsJoint* mySpringJoint6;
...
-(void) activateJointRope{
    ...
    _myPinJoint3 = [SKPhysicsJointPin jointWithBodyA:_mySquare4.physicsBody bodyB:_mySquare5.physicsBody anchor:_mySquare4.position];
    
    [self.physicsWorld addJoint:_myPinJoint3];
    
    _myPinJoint4 = [SKPhysicsJointPin jointWithBodyA:_mySquare5.physicsBody bodyB:_mySquare6.physicsBody anchor:_mySquare5.position];
    
    [self.physicsWorld addJoint:_myPinJoint4];
    
    
    _mySpringJoint5 = [SKPhysicsJointSpring jointWithBodyA:_mySquare6.physicsBody bodyB:_mySquare7.physicsBody anchorA:_mySquare6.position anchorB:_mySquare7.position];
    
    [self.physicsWorld addJoint:_mySpringJoint5];
...
-(void) spawnSquares{
    ...
    _mySquare2 = [[SKSpriteNode alloc]initWithColor:[SKColor purpleColor] size:CGSizeMake(40, 40)];
    _mySquare3 = [[SKSpriteNode alloc]initWithColor:[SKColor orangeColor] size:CGSizeMake(40, 40)];
    ...
    _mySquare6 = [[SKSpriteNode alloc]initWithColor:[SKColor whiteColor] size:CGSizeMake(40, 40)];
    _mySquare7 = [[SKSpriteNode alloc]initWithColor:[SKColor blueColor] size:CGSizeMake(40, 40)];
    _mySquare8 = [[SKSpriteNode alloc]initWithColor:[SKColor grayColor] size:CGSizeMake(40, 40)];
    
    
    [_mySquare1 setPosition:CGPointMake(self.size.width/2.5, self.size.height/2.5)];
    [_mySquare2 setPosition:CGPointMake(self.size.width/2.5, self.size.height/3)];
    [_mySquare3 setPosition:CGPointMake(self.size.width/2.5, self.size.height/2.5)];
    [_mySquare4 setPosition:CGPointMake(self.size.width/2.5, self.size.height/3)];
    [_mySquare5 setPosition:CGPointMake(self.size.width/2.5, self.size.height/2.5)];
    [_mySquare6 setPosition:CGPointMake(self.size.width/2.5, self.size.height/3)];
    [_mySquare7 setPosition:CGPointMake(self.size.width/2.5, self.size.height/2.5)];
    [_mySquare8 setPosition:CGPointMake(self.size.width/2.5, self.size.height/3)];
